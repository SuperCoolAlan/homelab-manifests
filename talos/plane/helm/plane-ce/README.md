...
| Setting | Default | Required | Description |
|---|:---:|:---:|---|
| env.secret_key | ***REMOVED*** | Yes | This must a random string which is used for hashing/encrypting the sensitive data within the application. Once set, changing this might impact the already hashed/encrypted data|
...
| app_env_existingSecret      | `SECRET_KEY`             | Yes | Random secret key                            | `***REMOVED***`  |
